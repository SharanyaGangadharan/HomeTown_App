...
import com.example.shara.assignment5.core.users.get.all.GetUsersContract;
import com.example.shara.assignment5.core.users.get.all.GetUsersPresenter;
import com.example.shara.assignment5.models.User;
import com.example.shara.assignment5.ChatActivity;
import com.example.shara.assignment5.ui.adapters.UserListingRecyclerAdapter;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ChatActivity.startActivity(getActivity(),
                ...
                mUserListingRecyclerAdapter.getUser(position).nickname);
    }
